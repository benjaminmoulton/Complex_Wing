...
class sphere:
    ...
    def region(self):
        ...
        axe = subfigs[0].add_subplot(111,projection='3d')
        face = 'z'
        ...
        axfreq = subfigs[1].add_subplot(811)
        freq_slider = Slider(
            ax=axfreq,
            label='zeta[0]',
            valmin=-5.0,
        ...
        # bxfreq = plt.axes([0.25, 0.1, 0.65, 0.03])
        # cxfreq = plt.axes([0.25, 0.1, 0.65, 0.03])
        # dxfreq = plt.axes([0.25, 0.1, 0.65, 0.03])
        # exfreq = plt.axes([0.25, 0.1, 0.65, 0.03])
        # fxfreq = plt.axes([0.25, 0.1, 0.65, 0.03])
        # gxfreq = plt.axes([0.25, 0.1, 0.65, 0.03])
        # hxfreq = plt.axes([0.25, 0.1, 0.65, 0.03])
